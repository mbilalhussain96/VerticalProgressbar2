...
class VerticalStepViewIndicator @JvmOverloads constructor(
    ...
    private var mCompletedLineColor = getContext().getColor(R.color.completed_color) //定义默认完成线的颜色      definition mCompletedLineColor
    ...
    private fun init() {
        mPath = Path()
//        mEffects = DashPathEffect(floatArrayOf(8f, 8f, 8f, 8f), 2f)
        ...
        mCompletedPaint!!.strokeWidth = 1f
...
//        circleRadius = 0.28f * defaultStepIndicatorNum
        circleRadius = 0.5f * defaultStepIndicatorNum
        //线与线之间的间距    set mLinePadding
//        mLinePadding = 0.85f * defaultStepIndicatorNum
        mLinePadding = 2f * defaultStepIndicatorNum
        mCompleteIcon = ContextCompat.getDrawable(context, R.drawable.action_check) //已经完成的icon
        mAttentionIcon = ContextCompat.getDrawable(context, R.drawable.ic_action_stop) //正在进行的icon
        mDefaultIcon = ContextCompat.getDrawable(context, R.drawable.ic_action_stop) //未完成的icon
...
//                circleRadius * 1.1f
//                mCompletedPaint!!.color = Color.GREEN
//                canvas.drawCircle(
//                    mCenterX,
...
//                mCompletedPaint!!.color = context.getColor(R.color.gray_color)
//                canvas.drawCircle(
//                    mCenterX,
//                    currentComplectedXPosition,
//                    circleRadius * 0.80f,
